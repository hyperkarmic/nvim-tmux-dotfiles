...
--  Use gx to open .md files in a buffer instead of an external app
...
require("todo-comments").setup {
  search = {
    pattern = [[\b(KEYWORDS):]], -- adjust the pattern to match your desired comments
  },
  filetypes = { "markdown", "customfiletype" }, -- add custom filetypes
}
...
['<CR>'] = cmp.mapping.confirm({ select = true }), -- Use Enter to confirm completion
    ['<C-y>'] = cmp.config.disable, -- Disable Ctrl-y as a confirmation key
...
--this is custom highlight and it's location - for todo purposes
vim.cmd [[highlight TodoHighlight guibg=#546178]]
vim.cmd [[autocmd VimEnter * match TodoHighlight /TODO/]]
