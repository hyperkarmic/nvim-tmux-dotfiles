...
--add file to arg list

keymap("n", "<M-a>", ":arge%<CR>", opts)
...
--keymaps for quickfix etc
--this allows for quick number access on quickfix
keymap("n","<M-q>",":clist<CR>:cc ",opts)
--this is literal magic...allows you to bounce between qf entries
keymap("n","]q",":cnext<CR>",opts)
keymap("n","[q",":cprev<CR>",opts)
--now the equivalent local-lists

keymap("n","<M-l>",":llist<CR>:ll ",opts)
...
keymap("n", "<leader>fp", ":lua require('telescope').extensions.neoclip.default()<CR>", opts)
keymap("n", "<leader>fg", ":Telescope live_grep<CR>", opts)
keymap("n", "<leader>fr", ":Telescope project<CR>", opts)
keymap("n", "<leader>fb", ":Telescope buffers<CR>", opts)
keymap("n", "<leader>fs", ":Telescope grep_string<CR>", opts) -- find string under cursor in current working directory
...
keymap("n", "<leader>fi", "<cmd>Telescope quickfixhistory<CR>",opts)
keymap("n", "<leader>fa", "<cmd>Telescope arglist<CR>",opts)
keymap("n", "<leader>fc", "<cmd>Telescope changes<CR>",opts)
keymap("n", "<leader>fw", "<cmd>Telescope file_browser<CR>",opts)
keymap("n", "<leader>f8", "<cmd>Telescope colorscheme<CR>",opts)
...
--enters terminal as buffer
keymap('n', '<M-t>', ':term<CR>', opts)
keymap('n', '<M-b>', ':tab sbuffer<Space>',opts)
--pens up new tab - with right code opens particualr buffer
--enters ex mode from buffer
keymap('t', '<M-t>', '<C-\\><C-n>', opts)
keymap('t', '<M-#>', '<C-\\><C-n>:b#<CR>', opts)
